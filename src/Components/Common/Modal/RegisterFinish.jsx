...
const RegisterFinish = () => {
    ...
    return (
      <div className="bg-black bg-opacity-40 text-center  ">
        ...
        <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div className="bg-white rounded-3xl  py-8 px-4 w-[26rem] h-[33rem]  shadow  sm:px-10">
              <div className="flex flex-row-reverse justify-between w-full ">
    
                <h2 className="my-6 text-center text-xl font-bold tracking-tight text-gray-800">ورود به حساب</h2>
                <div className=" my-6 w-10 h-10 bg-gray-100 cursor-pointer rounded-xl pt-2" > <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokewidth="1.5" stroke="currentColor" className=" m-auto w-6 h-6">
                          <path strokelinecap="round" strokelinejoin="round" stroke= "#3b82f6" d="m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"  />
                      </svg>
                </div>
              ...
              <form className="space-y-9" action="#" method="POST">
                ...
                <div className="flex  justify-between">
                  <div className="flex justify-end w-full ">
                    <label htmlFor="remember-me" className="ml-2 px-2 cursor-pointer block text-sm text-gray-900">
                      مرا به خاطر بسپار
                    </label>
                    <input
                      id="remember-me"
